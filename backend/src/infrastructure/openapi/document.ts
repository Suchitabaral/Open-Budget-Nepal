...
const endpoints: Endpoint[] = [
  ...
  { path: '/budgets/overview', tag: 'Budgets', summary: 'Get consolidated-data availability and coverage', parameters: ['fiscalYear'] },
  { path: '/budgets/federal', tag: 'Budgets', summary: 'Get canonical federal fiscal breakdown and trend', parameters: ['fiscalYear', 'factType'] },
  { path: '/budgets/provinces', tag: 'Budgets', summary: 'Get canonical provincial fiscal breakdown and trend', parameters: ['fiscalYear', 'factType'] },
  { path: '/budgets/provinces/{provinceId}', tag: 'Budgets', summary: 'Get fiscal data for one province', parameters: ['provincePath', 'fiscalYear', 'factType'] },
  { path: '/budgets/local-levels/{localLevelId}', tag: 'Budgets', summary: 'Get fiscal data for one canonical local level', parameters: ['localLevelPath', 'fiscalYear', 'factType'] },
  { path: '/budgets/classifications', tag: 'Budgets', summary: 'List the canonical fiscal classification hierarchy' },
...
const parameters: Record<string, object> = {
  ...
  factType: { name: 'factType', in: 'query', schema: { type: 'string', enum: ['BUDGET', 'ACTUAL'] } },
  provincePath: { name: 'provinceId', in: 'path', required: true, schema: { type: 'string' } },
  localLevelPath: { name: 'localLevelId', in: 'path', required: true, schema: { type: 'string' } },
