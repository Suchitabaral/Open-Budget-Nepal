  ...
  return (
    <AuthLayout title="Login" navLabel="Register" navLink="/signup">
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-input-border text-primary focus:ring-primary/20 accent-primary"
            />
        ...
        <button
          type="button"
          className="w-full py-3 rounded-lg bg-primary text-white font-medium hover:bg-primary-hover transition-colors flex items-center justify-center gap-2"
        >
